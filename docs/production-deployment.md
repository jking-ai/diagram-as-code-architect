...
flowchart TB
    ...
    subgraph GCP["Google Cloud Platform — jking-ai-labs / us-central1"]
        ...
        subgraph AR["Artifact Registry"]
            Repo[docker-repo<br/>us-central1-docker.pkg.dev/jking-ai-labs/docker-repo]:::purple
        end
...
gcloud run deploy diagram-architect-api \
  --image=us-central1-docker.pkg.dev/jking-ai-labs/docker-repo/diagram-architect-api:latest \
  --region=us-central1 \
  --platform=managed \
...
gcloud run deploy diagram-architect-api \
  --image=us-central1-docker.pkg.dev/jking-ai-labs/docker-repo/diagram-architect-api:latest \
  --region=us-central1 --project=jking-ai-labs
...
```bash
curl -s https://diagram-architect-api-153583612125.us-central1.run.app/api/v1/health
```
...
curl -s -H "X-API-Key: <key>" \
  https://diagram-architect-api-153583612125.us-central1.run.app/api/v1/diagrams/types
```
