...
**Project Status:** All 3 phases complete (22/22 deliverables)
...
./gradlew test       # Run all 56 tests (no GCP credentials needed)
```
...
```
diagram-as-code-architect/
|-- backend/          # Spring Boot API (Java 21) + Bruno API tests
|-- frontend/         # Astro single-page app
|-- functions/        # Firebase Cloud Function (API key proxy)
|-- demo/             # Demo script and sample data
|-- docs/             # Architecture, API contracts, deployment guides, milestones
...
- [Overview](docs/README.md) -- Project overview, capabilities, and quick links
- [Architecture](docs/architecture.md) -- System design, tech stack, and design decisions
- [API Contracts](docs/api-contracts.md) -- Endpoint specs, request/response examples, authentication, error codes
- [Milestones](docs/milestones.md) -- Development phases and deliverables (22/22 complete)
- [Production Deployment](docs/production-deployment.md) -- GCP resource inventory, build & deploy commands
- [Local Development Guide](docs/local-dev-guide.md) -- Prerequisites, credential setup, running locally
- [Local Testing Guide](docs/local-testing-guide.md) -- Automated tests, Bruno API collection, manual curl testing
